...
const deleteImage = async (req, res, next) => {
    try {
        ...
        const file_path = filePath.replace(process.env.S3_BUCKET_BASE_URL + "/", "");
        await s3bucket_1.default.remove(file_path);
        return response_1.default.success(res, {
            statusCode: 200,
...
const getMovieRating = async (movie_id) => {
    try {
        const ratings = await index_1.default.Rating.findAll({
